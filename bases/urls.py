...
urlpatterns = [
    ...
    path('frases/new', FraseNew.as_view(), name='frase_new'),
    path('subcategorias/edit/<int:pk>',FraseEdit.as_view(), name='frase_edit'),
    path('subcategorias/delete/<int:pk>',FraseDel.as_view(), name='frase_del'),
]
